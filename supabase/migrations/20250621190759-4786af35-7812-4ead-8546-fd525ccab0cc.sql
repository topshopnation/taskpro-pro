...
-- Update the verify_admin_credentials function to use proper password hashing
...
-- Now hash the existing plain text password
UPDATE admin_users 
SET password_hash = crypt('eur!trx1JUD!ryk-duy', gen_salt('bf'))
